function channelArithmetic(aImarisApplicationID, strArithmetic)
%CHANNELARITHMETIC  Carry out channel arithmetic 
%
%  CHANNELARITHMEETIC(imarisApplication, arithmeticString) will carry out
%  the arithmetic specified in arithmeticString. The result will be sent
%  back to Imaris as a new channel.
%
%  Modified from Imaris XTChannelArithmetic.m
